...
export PYTHONPATH="${PYTHONPATH}:/homes/natelgrw/Documents/turbo_circuit_optimizer/turbo_optimizer/working_current"
export BASE_TMP_DIR=/homes/natelgrw/Documents/turbo_circuit_optimizer/turbo_optimizer/base_tmp
	...
	python /homes/natelgrw/Documents/turbo_circuit_optimizer/turbo_optimizer/working_current/sample/random_sample_turbo.py #run the actual turbo code
	conda deactivate
