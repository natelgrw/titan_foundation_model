...
logging.basicConfig(filename="./ERROR_LOG/read_netlist.log", level=logging.DEBUG)

# Establishing lists of netlist components
OTA_DIR = "SOURCE_ota_unbiased"
BIAS_DIR = "SOURCE_bias"
LG_DIR = "SOURCE_local_generation"
            ...
            for BN in BIAS_NETLIST:
                ...
                if check_lg:
                    ...
                    if check_bias:
                        ...
                        fo = open("FINAL_OTA/" + ON + "_" + LN + "_" + BN, "w")
